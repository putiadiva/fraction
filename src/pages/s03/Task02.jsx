...
function Task02() {
	...
	const handleCek = () => {
		...
		if (arr.includes('a') && arr.includes('b') && arr.includes('c')) {
			console.log('benar !!!!!')
			window.location.href = '/s03/task02-true'
		} else {
			console.log('salah !!!!!')
			setShowModal(true)
		}
		...
		<MyBackground>
			<div className="my-container">
				...
				>
					...
					<Modal.Body>
						Perhatikan gambar satu-persatu. <span>Hitunglah</span>,
						ada berapa bagian brownies? Apakah ada 12? Apakah
						ukurannya sudah <span>sama</span>?
					</Modal.Body>
					<Modal.Footer>
						<Button variant="primary" onClick={handleCloseHint}>
