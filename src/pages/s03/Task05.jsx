...
function Task05() {
	...
	const handleCek = () => {
		if (A === '3' && B === '12') {
			window.location.href = '/s03/task05-true'
		} else {
			setShowModal(true)
		}
	}
		...
		<MyBackground>
			<div className="my-container">
				...
				>
					...
					<Modal.Body>
						Coba hitung <span>gabungan</span> dari bagian yang kamu
						ambil dan bagian yang kawanmu ambil!
						<br />
						<br />
						Ingat pula bahwa banyaknya semua potongan yang ada
						adalah <span>12</span> potong.
					</Modal.Body>
					<Modal.Footer>
